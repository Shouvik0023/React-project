...
export default function About(props) {
  return (
    <div>
        <p className={`text-${props.mode==='primary'?'dark':'light'} my-5`}>Originally created by a designer and a developer at Twitter, Bootstrap has become one of the most popular front-end frameworks and open source projects in the world.
